...
* 05/2025–Present: Research Intern  
  ...
  * Supervisor: Dr. Ashley Cook
    * We are investigating a newly proposed topological phase of matter, the [topological skyrmion semimetal](https://arxiv.org/abs/2311.15753), and its generalizations. The project is built on previous work by the Correlations and Topology group.
...
Skills
======
* **Programming & Digital skills**: Python (data processing, visualization, quantum programming), LaTeX (academic writing), Git (version control), Linux, SLURM  
